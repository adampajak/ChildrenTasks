...
import { createChildSchema } from "@/lib/schemas/children.schema";
import { listChildren, createChild } from "@/lib/services/children.service";
...
export const GET: APIRoute = async (context) => {
  ...
  try {
    const children = await listChildren(supabase);
