...
- [ ] 1.3 Tapping child name in Dziś tab opens ChildDayView for that child
- [ ] 1.4 ChildDayView shows only that child's today chores, full-width
- [ ] 1.5 "← Wszystkie dzieci" returns to all-children card grid
- [ ] 1.6 Tab bar hidden when focused; visible when in all-children view
- [ ] 1.7 Wygeneruj ponownie button visible in both states
- [ ] 1.8 Switching to Ten tydzień and back to Dziś resets to all-children view
- [ ] 1.9 No regressions in Today view, WeekView, generate/regenerate
